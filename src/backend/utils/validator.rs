...
pub fn check_nums(op: &Token, x: Option<f64>, y: Option<f64>) 
...
pub fn check_str(op: &Token, x: Option<String>) 
...
pub fn check_strs(op: &Token, x: Option<String>, y: Option<String>) 
